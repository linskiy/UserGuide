...
Для создания дополнительных услуг которые могут быть предложены только в первом периоде необходимо в поле добавить опцию выбрать необходимую позицию и нажать кнопку «+»  
...
Для создания дополнительной услуги, тарификация которой необходимо ввести какое либо значение необходимо в поле добавить опцию выбрать необходимую позицию и нажать кнопку «+»  
